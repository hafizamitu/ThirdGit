...
//        username
        driver.findElement(By.id("user")).sendKeys("mitu");
...
//        insert email
        driver.findElement(By.id("email")).sendKeys("mitu@gmail.com");
...
//        Date Selector
        driver.findElement(By.id("q7")).sendKeys("2-14-2024");
...
//        Select by visible text
        dropdown4.selectByVisibleText("Mrs.");
        
        
//        Inserting First name
        driver.findElement(By.name("q11_first")).sendKeys("Hafiza Alam");
        
//        Inserting Last name
        driver.findElement(By.name("q11_last")).sendKeys("Mitu");
